...
#include "shr_assert.h"
  ...
  type, public :: temperature_type
     ...
     real(r8), pointer :: t_whiteroof_scaling3_lun (:)   ! lun white roof surface temperature (K)          
     real(r8), pointer :: t_roof_scaling4_lun      (:)   ! lun white roof surface temperature (K)          
     real(r8), pointer :: t_whiteroof_scaling4_lun (:)   ! lun white roof surface temperature (K)          
     real(r8), pointer :: t_roof_scaling5_lun      (:)   ! lun white roof surface temperature (K)          
     real(r8), pointer :: t_whiteroof_scaling5_lun (:)   ! lun white roof surface temperature (K)          
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%t_whiteroof_scaling3_lun (begl:endl))                      ; this%t_whiteroof_scaling3_lun (:)   = nan 
    allocate(this%t_roof_scaling4_lun      (begl:endl))                      ; this%t_roof_scaling4_lun      (:)  = nan 
    allocate(this%t_whiteroof_scaling4_lun (begl:endl))                      ; this%t_whiteroof_scaling4_lun (:)   = nan 
    allocate(this%t_roof_scaling5_lun      (begl:endl))                      ; this%t_roof_scaling5_lun      (:)   = nan 
    allocate(this%t_whiteroof_scaling5_lun (begl:endl))                      ; this%t_whiteroof_scaling5_lun (:)   = nan 
  ...
  subroutine InitHistory(this, bounds, is_simple_buildtemp, is_prog_buildtemp )
    ...
    this%t_whiteroof_scaling3_lun(begl:endl) = spval
    call hist_addfld1d(fname='TWHITEROOF_SCALING3', units='K',  &
        avgflag='A', long_name='white roof scaling3 temperature', &
        ptr_lunit=this%t_whiteroof_scaling3_lun, set_nourb=spval, l2g_scale_type='unity', &
        default='inactive')   
                    
    this%t_roof_scaling4_lun(begl:endl) = spval
    call hist_addfld1d(fname='ROOF_SCALING4', units='K',  &
        avgflag='A', long_name='roof scaling4 temperature', &
        ptr_lunit=this%t_roof_scaling4_lun, set_nourb=spval, l2g_scale_type='unity', &
        default='inactive')   
                    
    this%t_whiteroof_scaling4_lun(begl:endl) = spval
    call hist_addfld1d(fname='TWHITEROOF_SCALING4', units='K',  &
        avgflag='A', long_name='white roof scaling4 temperature', &
        ptr_lunit=this%t_whiteroof_scaling4_lun, set_nourb=spval, l2g_scale_type='unity', &
        default='inactive')   
                    
    this%t_roof_scaling5_lun(begl:endl) = spval
    call hist_addfld1d(fname='ROOF_SCALING5', units='K',  &
        avgflag='A', long_name='roof scaling5 temperature', &
        ptr_lunit=this%t_roof_scaling5_lun, set_nourb=spval, l2g_scale_type='unity', &
        default='inactive')   
                    
    this%t_whiteroof_scaling5_lun(begl:endl) = spval
    call hist_addfld1d(fname='TWHITEROOF_SCALING5', units='K',  &
        avgflag='A', long_name='white roof scaling5 temperature', &
        ptr_lunit=this%t_whiteroof_scaling5_lun, set_nourb=spval, l2g_scale_type='unity', &
        default='inactive')   
