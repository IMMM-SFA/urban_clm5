      ...
      do fp = 1,num_urbanp
         ...
         if (ctype(c) == icol_roof) then   
            ...
            lwnet_whiteroof_surface(l) = lwnet_whiteroof(l)
                 ...
                 t_whiteroof_scaling2(l) = (sabs_whiteroof_dir(l,1)-sabs_roof_dir(l,1))*forc_solad(g,1) + &
                 (sabs_whiteroof_dif(l,1)-sabs_roof_dif(l,1))*forc_solai(g,1) + &
                 (sabs_whiteroof_dir(l,2)-sabs_roof_dir(l,2))*forc_solad(g,2) + &
                 (sabs_whiteroof_dif(l,2)-sabs_roof_dif(l,2))*forc_solai(g,2) 
                 
           write (iulog,*) 't_whiteroof_scaling2(l)= ', t_whiteroof_scaling2(l)
