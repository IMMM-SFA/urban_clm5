...
contains
  ...
  logical function hasBedrock(col_itype, lun_itype)
    ...
    !if (is_hydrologically_active(col_itype=col_itype, lun_itype=lun_itype)) then !!!wangly
    !   SHR_ASSERT(hasBedrock, "hasBedrock should be true for all hydrologically-active columns")  !!!wangly
    !end if !!!wangly
