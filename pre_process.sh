...
path1=/global/cscratch1/sd/wangly/wrfout2/ori/  # directory for input: the origional WRF data
path2=/global/cscratch1/sd/wangly/wrfout2/mon/  # directory for output: one file for each month

cd $path1
#mkdir old
for year in `seq -w 2019 2059`
do
